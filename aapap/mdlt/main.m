...
figure;
% imshow(linear_hom);
imwrite(linear_hom, './images/result1.jpg');
...
figure;
% imshow(linear_mdlt);
imwrite(linear_mdlt, './images/result2.jpg');
cropW = min([TR(1) BR(1)]);
cropH = size(img1, 1);
rect = [1, off(2), cropW, cropH];
corpImage = imcrop(linear_mdlt, rect);
imwrite(corpImage, './images/crop.jpg');
